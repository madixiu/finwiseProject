...
export default {
  ...
  methods: {
    ...
    liveData() {
      let interval = setInterval(() => {
        ...
        this.$socketMarketHighestSupplies.send(JSON.stringify(barier));
  ...
  mounted() {
    this.$socketMarketHighestSupplies.send(JSON.stringify({ request: "get" }));
    this.liveChecker();
    this.$socketMarketHighestSupplies.onmessage = data => {
