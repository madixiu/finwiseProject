    ...
    <div>
        ...
        <div class="row h-100 ">
          <div class="col-sm-3">
            ...
            height="250"
            max-width="500"
            outlined class="col-sm-4">
              <!-- <v-card-title>شتران</v-card-title> -->
              <div class="row mr-7 mt-1">
                <div class="col-12">
                  <span class="tickerName">{{tickerName}}</span>
                </div>
              </div>
             
              <div class="row mr-10 mt-2">
                 <div class="col-7">
              ...
              <div class="mt-7">
                <table class="tickerCard">
                  <tbody>
                    <tr>
                      <td>{{Volume}} :حجم</td>
                      <!-- <td>{{Volume}}</td> -->
                      
                      <td>{{AverageVolume}} :میانگین حجم</td>
                      <!-- <td>{{Volume}}</td> -->
                    </tr>
                    <tr>
                      <td>{{MarketCap}}   :ارزش بازار</td>
                      <!-- <td>{{Volume}} :حجم</td>
                      <td>{{Volume}} :حجم</td> -->
                      <td>{{Volume}}   :Enterprise Value</td>
                    </tr>
                    <tr>
                      <!-- <td>{{Volume}} :حجم</td>
                      <td>{{Volume}} :حجم</td> -->
...
table.tickerCard td, table.tickerCard th {
  padding: 5px 5px;
    direction: ltr;
}
table.tickerCard tbody td {
  font-size: 10px;
