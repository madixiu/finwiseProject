          ...
          <v-card rounded="lg">
            <v-toolbar dense style="height:36px;">
              <v-toolbar-title style="height:20px;font-size:0.95em">
                صورت سود و زیان دوره {{ itemPeriod }} ماه منتهی به
                {{ selectedMonth }} - سال مالی
                {{ itemfiscalYear }}
              </v-toolbar-title>
              <v-spacer></v-spacer>
            ...
            <v-card-text>
              <b-table
                class="IncomeStatementWidget-table"
                thClass="IncomeStatementWidget-tableHeader"
                tbody-tr-class="IncomeStatementWidget-table-row"
                small
                hover
                fixed
                :items="filteredItems"
...
<style scoped>
.IncomeStatementWidget-table {
  text-align: center;
  font-size: 0.8rem;
  line-height: 1;
  font-family: "Vazir-Medium-FD";
}
.IncomeStatementWidget-table /deep/ .IncomeStatementWidget-tableHeader {
  font-size: 1em !important;
  /* font-weight: 300; */
  text-align: center;
}
.IncomeStatementWidget-table /deep/ .ticker-assembly-table-row {
  direction: ltr;
