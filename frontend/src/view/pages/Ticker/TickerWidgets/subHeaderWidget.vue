  ...
  computed: {
    ...
    EV() {
      if (this.LiveDataItems.last != undefined && this.DebtAndCash != 0) {
        return this.roundTo(
          ((this.LiveDataItems.last * this.LiveDataItems.ShareCount) -this.DebtAndCash)/ 1000000000,
          2
        ).toLocaleString();
      } else return "-";
    },
    PtoE() {
      if (this.LiveDataItems.last != undefined && this.EarningNRI != 0) {
        return this.roundTo(
          (this.LiveDataItems.last * this.LiveDataItems.ShareCount) /  (this.EarningNRI*1000000),
          2
        ).toLocaleString();
      } else return "-";
    },
    PtoB() {
       ...
       if (this.LiveDataItems.last != undefined && this.Equity != 0) {
        return this.roundTo(
          (this.LiveDataItems.last * this.LiveDataItems.ShareCount) /  (this.Equity*1000000),
          2
        ).toLocaleString();
      } else return "-";
    }
